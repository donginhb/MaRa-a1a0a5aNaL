...
/* enable^name^password */
struct attr hs_user_rule[] = {
    { "enable", show_value, show_value },
    { "name", show_value, show_value },
    { "password", show_value, show_value },
    { NULL, NULL, NULL }
...
/* ^brand^pages_mode^title^header_elements_contents^header_contents^welcome_contents^tos_agreement^advertisement_contents^footer_contents */
struct attr hs_pages_rule[] = {
    { "HS_NONE", show_value, show_value },
    { "brand", show_value, show_value },
    { "pages_mode", show_value, show_value },
    { "title", show_value, show_value },
    { "header_elements_contents", show_value, show_value },
    { "header_contents", show_value, show_value },
    { "welcome_contents", show_value, show_value },
    { "tos_agreement", show_value, show_value },
    { "advertisement_contents", show_value, show_value },
    { "footer_contents", show_value, show_value },
    { NULL, NULL, NULL }
};

/* tos_enable^tos_contents*/
struct attr hs_tos_rule[] = {
    { "tos_enable", show_value, show_value },
    { "tos_contents", show_value, show_value },
    { NULL, NULL, NULL }
};
/* hs_enable^mode^ipaddr^mask^192.168.182.1^uam_port^uam_ui_port^uamsecret^uam_allow^/www/welcome.html^/www/status.html^/www/goodbye.html^auto^10.1.1.254^radius_ipaddr^radius_ipaddr1^radius_auth_port^radius_accp_port^radius_secret^nasid^locname^Proxicast^userdb */
struct attr hs_server_rule[] = {
    { "enable" , show_value, show_value },
    { "mode" , show_value, show_value },
    { "ipaddr" , show_value, show_value },
    { "mask" , show_value, show_value },
    { "hs_none_1" , show_value, show_value },
    { "uam_port" , show_value, show_value },
    { "uam_ui_port" , show_value, show_value },
    { "uam_secret" , show_value, show_value },
    { "uam_allow" , show_value, show_value },
    { "hs_none_2" , show_value, show_value },
    { "hs_none_3" , show_value, show_value },
    { "hs_none_4" , show_value, show_value },
    { "hs_none_5" , show_value, show_value },
    { "hs_none_6" , show_value, show_value },
    { "radius_ipaddr" , show_value, show_value },
    { "radius_ipaddr1" , show_value, show_value },
 ...
 * iphone^barry^smart^usbled^wimax^beceem^guest_lan */
...
struct rule rules[] = {
    ...
    { "hs_server_rule", hs_server_rule },
    { "hs_pages_rule", hs_pages_rule },
    { "hs_tos_rule", hs_tos_rule },
    { "hs_user_rule", hs_user_rule },
    //{ "hs_user_rule_num", hs_user_rule_num },
    //{ "hs_user_rule_max", hs_user_rule_max },
