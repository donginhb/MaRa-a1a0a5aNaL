 ...
 * (5) MessageContent, Shown ,WanInterfaceName
 *
 * XXX: 
...
#define EZP_COM_MAP_HUAWEI(X)                       \
    ...
    X("E3131",       \
            ...
            3, 0, 0, "ttyUSB",                         \
	    "55534243123456780000000000000011060000000000000000000000000000", 1, "usb0") \
    X("E122",       \
    ...
    X("E1550",       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 0, 0, "ttyUSB",                         \
            "55534243000000000000000000000011060000000000000000000000000000", 1, "usb0") \
    X("E156G",       \
            0x1003, HUAWEI, 0x0, 0x0, 0x0, -1,       \
            1, 1, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
    ...
    X("E353",       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                              \
            3, 0, 0, "ttyUSB",                         \
            "55534243123456780000000000000011062000000100000000000000000000", 1, "usb0") \
    X("E367",       \
    ...
    X("E392",      \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                              \
            2, 0, 0, "ttyUSB",                         \
            "55534243123456780000000000000a11062000000000000100000000000000", 0, "usb0") \
    X("E398",       \
    ...
    X("EC1260 (Alternative)",       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 0, "ttyUSB",                         \
            "555342431234567824000000800008FF05B112AEE102000000000000000000", 1, "usb0") \
    X("EC156",                                  \
...
#define EZP_COM_MAP_OPTION(X)                \
    X("AnyDATA ADU-500A/ADU-510A/ADU-520A",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "5553424312345678000000000000061b000000020000000000000000000000", 1, "usb0") \
    X("GlobeSurfer Icon 7.2",        \
            0x1000, OPTION2, 0x6901, 0x0, 0x05, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243123456780000000000000601000000000000000000000000000000", 1, "usb0") \
    ...
    X("SGH-Z810",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243123456780000000000000616000000000000000000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            0, 0, 0, "",                            \
...
#define EZP_COM_MAP_OPTION2(X)                \
    X("iCon 401 (HSO)",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            4, 3, 1, "ttyHS",                         \
            "55534243785634120100000080000601000000000000000000000000000000", 1, "usb0") \
...
#define EZP_COM_MAP_ZTE(X)                      \
    X("Generic",                                       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 2, 2, "ttyUSB",                         \
            "55534243123456782000000080000c85010101180101010101000000000000", 1, "usb0") \
    X("K3565-Z",                                       \
    ...
    X("MC2716",                                       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            4, 0, 0, "ttyUSB",                         \
            "55534243f8f993882000000080000a85010101180101010101000000000000", 1, "usb0") \
    X("MF622",                                       \
    ...
    X("MF628",                                       \
            ...
            3, 2, 1, "ttyUSB",                         \
            "5553424312345678000000000000061b000000030000000000000000000000", 1, "usb0") \
    X("MF628+",                                       \
            0x2000, ZTE, 0x0031, 0x0, 0x01, -1,   \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 2, 2, "ttyUSB",                         \
    ...
    X("MF820",                                       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 3, 3, "ttyUSB",                         \
            "55534243e856e2892400000080000685000000240000000000000000000000", 1, "usb0")   \
    X("MF821",                                       \
            0x0166, ZTE, 0x0257, 0x0, 0x01, -1,   \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 3, 3, "ttyUSB",                         \
            "55534243123456782400000080000685000000240000000000000000000000", 1, "usb0")   \
    X("MU351",                                       \
    ...
    X("ONDA MT503HS",                                       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 2, 1, "ttyUSB",                         \
            "55534243b0c8dc812000000080000a85010101180101010101000000000000", 1, "usb0") \
    X("ONDA MT505UP",                                       \
            0x2000, ZTE, 0x0002, 0x0, 0x03, -1,   \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 2, 1, "ttyUSB",                         \
            "55534243123456780000010080000a28000000001c00002000000000000000", 1, "usb0") \
    X("ONDA MT525UP",                                       \
...
#define EZP_COM_MAP_NOVATEL_MERLIN(X)                      \
    ...
    X("Wireless U679",     \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 0, "ttyUSB",                       \
            "5553424312345678000000000000061b000000020000000000000000000000", 4, "usb0") \
    X("Wireless U760",     \
...
#define EZP_COM_MAP_ALCATEL(X)                \
    X("D200",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            3, 3, 3, "ttyUSB",                         \
            "55534243123456788000000080000606f50402527000000000000000000000", 1, "usb0") \
    X("OT-X020/DBM-100HU (Nuton 3.5G)",        \
            0x1001, ALCATEL, 0x6061, 0x0, 0x05, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243123456780000000000000606f50402527000000000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "",                            \
...
#define EZP_COM_MAP_SOLOMON(X)                \
    X("S3Gm-660",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243123456781200000080000603000000020000000000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            0, 0, 0, "",                            \
...
#define EZP_COM_MAP_CMOTECH(X)                \
    X("CGU-628",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243d85dd88524000000800008ff524445564348470000000000000000", 1, "usb0") \
    X("D-50/CDU-680",        \
            0x6803, CMOTECH, 0x6803, 0x0, 0x07, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "555342431234567824000000800008ff524445564348470000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            0, 0, 0, "",                            \
...
#define EZP_COM_MAP_UTSTARCOM(X)                \
    X("UM175",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 0, 1, "ttyUSB",                         \
            "555342431234567824000000800008ff024445564348470000000000000000", 1, "usb0") \
    X("UML290",        \
...
#define EZP_COM_MAP_3GO(X)                      \
    X("3GO11",                                       \
            ...
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            2, 2, 2, "ttyUSB",                         \
            "5553424320099384800000008000060619181a207000000000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH,                               \
            0, 0, 0, "",                            \
...
#define EZP_COM_MAP_LG(X)                \
    X("LDU-1900D EV-DO",        \
            ...
            0, 0, 0x0, HOTPLUG_BOTH ,                               \
            2, 0, 1, "ttyUSB",                         \
            "55534243123456780000000000000aff554d53434847000000000000000000", 1, "usb0") \
    X("",        \
            0x0, EMPTY, 0x0, 0x0, 0x0, -1,  \
            0, 0, 0x0, HOTPLUG_BOTH ,                               \
            0, 0, 0, "",                            \
...
#define EZP_COM_MAP_CONVERTER(NAME,PID,TVNAME,TPID,TCLS,EP,REP,DT,MODE,INTF,HOTPLUG,DNUM,DTTY,CTTY,DEVNMAE,MSG,FLAG,IFNAME) \
   {NAME, PID, EZP_COM_VID_##TVNAME, TPID, TCLS, EP, REP, DT, MODE, INTF, HOTPLUG, DNUM, DTTY, CTTY, DEVNMAE, MSG, FLAG, IFNAME},
