...
special_processing(char *new_str)
{
    ...
    /* XXX need to remove later 
     * Modify default ssid for MR-102N and MR-105NL */
    if ((!strcmp("P", nvram_safe_get("prod_cat")) &&
                atoi(nvram_safe_get("prod_subcat")) == 1) ||
            !strcmp("U", nvram_safe_get("prod_cat"))) {
        nvram_fset("wl0_ssid_rule_default", "AXIMCom1|AXIMCom2");
    }
...
int fw_func_2_0_9_to_3_0_0(void)
{
    printf("fw_func_2_0_9_to_3_0_0\n");
    return 0;
}

int fw_func_3_0_0_to_2_0_9(void)
{
    printf("fw_func_3_0_0_to_2_0_9\n");
    return 0;
}
   int fw_func_3_0_0_to_3_0_1(void)
{
    printf("fw_func_3_0_0_to_3_0_1\n");
    return 0;
}

int fw_func_3_0_1_to_3_0_0(void)
{
    printf("fw_func_3_0_1_to_3_0_0\n");
    return 0;
}
int fw_func_3_0_1_to_3_0_2(void)
{
    printf("fw_func_3_0_1_to_3_0_2\n");
    return 0;
}

int fw_func_3_0_2_to_3_0_1(void)
{
    printf("fw_func_3_0_2_to_3_0_1\n");
    return 0;
}
int fw_func_3_0_2_to_3_0_3(void)
{
    printf("fw_func_3_0_2_to_3_0_3\n");
    return 0;
}

int fw_func_3_0_3_to_3_0_2(void)
{
    printf("fw_func_3_0_3_to_3_0_2\n");
    return 0;
}
