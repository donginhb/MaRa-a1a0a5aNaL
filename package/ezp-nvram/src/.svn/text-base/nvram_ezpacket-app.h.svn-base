...
#define APPMBG_RULE     APPMGR_WLAN"^"APPMGR_ISCSI"^"APPMGR_PPTP"^"APPMGR_L2TP"^"APPMGR_IPSEC"^"APPMGR_STORAGE"^"APPMGR_WWAN"^"APPMGR_WISP"^"APPMGR_PORTCFG"^"APPMGR_HWNAT"^"APPMGR_FIRMWARE"^"APPMGR_IPHONE"^"APPMGR_BARRY"^"APPMGR_SMART"^"APPMGR_USBLED"^"APPMGR_WIMAX"^"APPMGR_BECEEM"^"APPMGR_GUEST_LAN
#endif
