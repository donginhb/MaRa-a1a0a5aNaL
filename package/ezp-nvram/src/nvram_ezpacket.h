...
#if defined(EZP_PROD_CAT_P) || defined(EZP_PROD_CAT_K) || defined(EZP_PROD_CAT_U) || defined(EZP_PROD_CAT_W)
    #define CT_MAX "10000"
#else
    #define CT_MAX "20000"
#endif
...
#if defined(EZP_PROD_CAT_P) || defined(EZP_PROD_CAT_W) || defined(EZP_PROD_CAT_K)
    #define CT_MAX "10000"
#else
    #define CT_MAX "20000"
#endif
...
#if !defined(EZP_PROD_SUPERCAT_X)
    #if defined(EZP_PROD_CAT_M) || defined(EZP_PROD_CAT_P) || defined(EZP_PROD_CAT_W) || defined(EZP_PROD_CAT_U)
...
#define WAN_BW_RULE "2M256K^2048^256^0^0^90^95^95^155^19^1244^155"
...
#endif
#define HS_SERVER_RULE "0^simple^192.168.182.1^24^192.168.182.1^3990^4990^uamsecret^^/www/welcome.html^/www/status.html^/www/goodbye.html^auto^10.1.1.254^10.1.1.230^10.1.1.230^1812^1813^radiussecret^mynas_1^Proxicast^Proxicast^/etc/chilli/localusers"
#define HS_TOS_RULE "0^"
#define HS_USER_RULE "^^|^^|^^|^^|^^|^^|^^|^^|^^|^^"
#define HS_USER_RULE_NUM "0"
#define HS_USER_RULE_MAX "10"
#define HS_PAGES_RULE "^PROX^default^HotSpot^^^^^^"
#define HS_HTTP_URL ""
...
#define WL_ADVANCED_RULE "1^ap^default^0^2346^2347^1^100^0^1^1^off^off^off^1^0^0^0^0^0^1^1^0^33^5^0^1^64^0^0^0|1^ap^default^0^2346^2347^1^100^0^1^1^off^off^off^1^0^0^0^0^0^1^1^0^33^5^0^1^64^0^0^0"
