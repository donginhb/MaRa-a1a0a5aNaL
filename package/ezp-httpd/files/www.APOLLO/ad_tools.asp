...
<%prod_show_html_start("PROD_CAT_P|PROD_CAT_W|PROD_CAT_M|PROD_CAT_N|PROD_CAT_U|PROD_CAT_I|PROD_CAT_A", "0", "4");%>
            <fieldset>
              ...
              <div class='SettingSubmitButton-Wrapper'>
                <input type="button" name="atcommand" id="atcommand" class='SettingSubmitButton' value='<%lang("Send Command");%>' onclick= "to_attool(this.form, 'atcommand')">
              </div>
...
<%prod_show_html_end("PROD_CAT_P|PROD_CAT_W|PROD_CAT_M|PROD_CAT_N|PROD_CAT_U|PROD_CAT_I|PROD_CAT_A", "0", "4");%>
          </form>
        </div>
