...
function onoffhotspot() {
	...
	//for special
	$("#hs_mode").attr("disabled",true);
	$("input[name='hs_pages_mode']").attr("disabled",true);
    ...
    <div id="wrapper">
	  ...
	  <script type="text/javascript">do_hidden_elements('hotspot_rule')</script>
 	    ...
 	    <div class="setting">
              ...
              <div class="label"><%nv_attr_get("wl0_ssid_rule","1","ssid");%></div><br>
            </div>
 		  ...
 		  <option value="simple" <%nvg_attr_match("hs_mode","hs_server_rule","0","mode","simple","selected"); %>><%lang("Splash Page");%>
            ...
            <div class="setting">
	    	<div class="label"><% lang("HTTP URL"); %></div>
	    	http://<input type="text" id="hs_http_url" name="hs_http_url" value="<%nv_get("hs_http_url");%>"/>
	    </div>
 	    <!--<% hs_show_setting(); %>--!>
