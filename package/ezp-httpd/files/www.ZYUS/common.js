...
//                                E('wan'+j+'_action').innerHTML = '';
                    ...
                    if (pair[0] == 'wan'+j+'_gateway') {
                        E('wan'+j+'_gateway').innerHTML = pair[1];
                    }
                    if (pair[0] == "Rx"+j) {
                       // rx[j] = pair[1];
                        var speed = adj_speed(pair[1]);
                        E('wan'+j+'_rx').innerHTML = speed;
                    } 
                    if (pair[0] == "Tx"+j) {
                       // tx[j] = pair[1];
                        var speed = adj_speed(pair[1]);
                        E('wan'+j+'_tx').innerHTML = speed;
                    } 
                    if (pair[0] == "Rx_Max"+j) {
                        rx_max[j] = pair[1];
                    } 
...
<%prod_show_js_start("PROD_CAT_M|PROD_CAT_N|PROD_CAT_P|PROD_CAT_U|PROD_CAT_A", "0", "6");%>
                if (pair[0] == "USB") {
...
<%prod_show_js_end("PROD_CAT_M|PROD_CAT_N|PROD_CAT_P|PROD_CAT_UPROD_CAT_A", "0", "6");%>
<%prod_show_js_start("PROD_CAT_C|PROD_CAT_T|PROD_CAT_D|PROD_CAT_K", "0", "6");%>
                var size, used;
                if (pair[0] == "USB") {
                    if (E("usb_img") != undefined) {
                        usb = pair[1];
...
<%prod_show_js_end("PROD_CAT_C|PROD_CAT_T|PROD_CAT_D|PROD_CAT_K", "0", "6");%>
<%prod_show_js_start("PROD_CAT_C|PROD_CAT_T|PROD_CAT_D|PROD_CAT_K", "3", "6");%>
                if (pair[0] == 'iscsi_on') {
                    if (pair[1] == '0') {
                        E('iscsi_on').value = '0';
...
<%prod_show_js_end("PROD_CAT_C|PROD_CAT_T|PROD_CAT_D|PROD_CAT_K", "3", "6");%>
<%prod_show_js_start("PROD_CAT_C|PROD_CAT_T|PROD_CAT_D|PROD_CAT_K", "0", "6");%>
                if (pair[0] == 'swap_on') {
                    if (pair[1] == '0') {
