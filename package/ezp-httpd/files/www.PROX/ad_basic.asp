...
#upgrade-time {
  ...
  function to_reboot(F) {
        ...
        ajax_preaction(F, "reboot.cgi", 4000);
         display_mask(F);
        return true;
  }
  ...
  function to_import(F) {
	...
	if (!confirm('Are you sure to import ' + name + ' ?')) 
        	return;
	  ...
	  <script type="text/javascript">do_page_path('<%lang("Admin");%>', '<%lang("Management");%>')</script>
        <div id="contentsInfo">
          <form name="form" action="apply.cgi" method="post" id= "setup">
            ...
            <input type="hidden" name="reboot_rule" value="ntp">
       ...
       <fieldset>
	    ...
	    <input type="hidden" name="lang" value="EN_PROX">
<!--
              <div class="setting">
                <div class="label">
                  <%lang("Language");%>
...
-->
              ...
              <div class="setting">
                ...
                <div class='radiobutton'><input type="radio" value="1" name= "http_rmgt_enable"
                <% nvg_attr_match("http_rmgt_enable","http_rule","0","rmgt_enable","1","checked"); %>><% lang("Enable"); %></input></div>
                <div class='radiobutton'><input type="radio" value="0" name= "http_rmgt_enable"  
                <% nvg_attr_match("http_rmgt_enable","http_rule","0","rmgt_enable","0","checked"); %>><% lang("Disable"); %></input></div>
              </div>
            ...
            <fieldset>
              <legend><% lang("Reboot"); %></legend>
                <div class="setting">
                  ...
                  '<%nv_attr_get("cron_rule", "$0", "reboot_interval");%>'
                        ...
                        "This number must be between 5 and 43200.(which is equal to 30 days). ")' />
                  (5 ~ 43200 min(s))
                </div>
                <div class="setting">
                  <div class="label">
              ...
              <div class='setting'>
                <div class="label">
                  <% lang("Reboot Manually"); %>
                </div>
                <input type="button" value='<%lang("Reboot Router");%>' onclick= "to_reboot(this.form)" class='SettingSubmitButton'>
              </div>
            </fieldset><br />
            ...
            <fieldset>
              ...
              <div class="setting">
                ...
                <input type="file" name="cfgfile" size="20" />
...
<%prod_show_html_start("firmware", "0", "100");%>
            <fieldset>
              ...
              <input type="file" name="binfile" size="20" />
