 	<div class="setting">
              ...
              <div class='radiobutton'><input type="radio" value="1" name="hs_tos_enable" onchange="onofftos()"
                   <%nvg_attr_match("hs_tos_enable","hs_tos_rule","$0","tos_enable","1","checked");%>>
                   <%lang("Enable");%>
               </input></div>

               <div class='radiobutton'><input type="radio" value="0" name="hs_tos_enable" onchange="onofftos()"
             ...
             <% tbl_get("hs_user_rule"); %>

	     <fieldset>
                <legend><%lang("User Rule");%></legend>
                <%tbl_create_table("hs_table", "hs_user_rule", "1");%>
                <script type="text/javascript">
                  tbl_setup_table("hs_table", hs_user_rule);
                  onofftos();
