...
#define SERV_UPDATEAXIMDDNS                   (82)
#define ACTION_UPDATEAXIMDDNS_STOP            (82)
#define ACTION_UPDATEAXIMDDNS_START           (83)

#define SERV_HOTSPOT                   (84)
#define ACTION_HOTSPOT_STOP            (84)
#define ACTION_HOTSPOT_START           (85)
/*
#define ACTION_NOTHING                  (0x00LL << 0)
...
/*Hotspot*/
extern int valid_hotspot(webs_t wp, char *value, struct variable *v);
extern int save_hotspot(webs_t wp, char *value, struct variable *v, struct service *s);
/* for WAN */
...
/* for Reboot */
extern int valid_reboot(webs_t wp, char *value, struct variable *v);
extern int save_reboot(webs_t wp, char *value, struct variable *v,
        struct service *s);

/* for Cron_NTP */
extern int valid_cron_ntp(webs_t wp, char *value, struct variable *v);
extern int save_cron_ntp(webs_t wp, char *value, struct variable *v,
        struct service *s);
