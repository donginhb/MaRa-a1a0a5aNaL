...
define KernelPackage/usb-core
  ...
  DEPENDS:=@USB_SUPPORT
#  KCONFIG:=CONFIG_USB
#  AUTOLOAD:=$(call AutoLoad,56,usbcore)
endef
...
define KernelPackage/usb-GobiSerial
  $(call usbdep,kmod-usb-serial @LINUX_2_6)
  TITLE:=Support for Option HSDPA modems
  KCONFIG:=CONFIG_USB_GOBI_SERIAL
  FILES:=$(LINUX_DIR)/drivers/usb/serial/GobiSerial.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,65,GobiSerial)
endef

define KernelPackage/usb-GobiSerial/description
 Kernel support for Keyspan USB-to-Serial devices
endef

$(eval $(call KernelPackage,usb-GobiSerial))

define KernelPackage/usb-GobiNet
  $(call usbdep,kmod-usb-serial @LINUX_2_6)
  TITLE:=Support for Option HSDPA modems
  KCONFIG:=CONFIG_USB_GOBI_NET
  FILES:=$(LINUX_DIR)/drivers/usb/serial/GobiNet/GobiNet.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,66,GobiNet)
endef

define KernelPackage/usb-GobiNet/description
 Kernel support for Keyspan USB-to-Serial devices
endef

$(eval $(call KernelPackage,usb-GobiNet))
...
define KernelPackage/usb-net-sierra
  $(call usbdep,kmod-usb-net @LINUX_2_6_26)
  TITLE:=Kernel module for Sierra USB High Speed Mobile Devices
  KCONFIG:= \
	CONFIG_RFKILL \
	CONFIG_RFKILL_INPUT \
  ...
  FILES:= \
	$(LINUX_DIR)/net/rfkill/rfkill.$(LINUX_KMOD_SUFFIX) \
	$(LINUX_DIR)/drivers/$(USBNET_DIR)/sierra_net.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,61,rfkill sierra_net)
endef

define KernelPackage/usb-net-sierra/description
 Kernel module for Sierra USB High Speed Mobile Devices
endef

$(eval $(call KernelPackage,usb-net-sierra))

define KernelPackage/usb-net-iphone
  $(call usbdep,kmod-usb-net @LINUX_2_6_26)
  TITLE:=Kernel module for iPhone Devices
  KCONFIG:= \
	CONFIG_USB_IPHETH
  FILES:= \
	$(LINUX_DIR)/drivers/$(USBNET_DIR)/ipheth.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,61,ipheth)
endef

define KernelPackage/usb-net-iphone/description
 Kernel module for iPhone Devices
endef

$(eval $(call KernelPackage,usb-net-iphone))

define KernelPackage/usb-net-iburst
  $(call usbdep,kmod-usb-net @LINUX_2_6_26)
  TITLE:=Kernel module for iBurst USB High Speed Mobile Devices
  KCONFIG:= \
	CONFIG_USB_IBURST
  FILES:= \
	$(LINUX_DIR)/drivers/$(USBNET_DIR)/ib-net.$(LINUX_KMOD_SUFFIX) \
	$(LINUX_DIR)/drivers/$(USBNET_DIR)/ib-usb.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,61,ib-net ib-usb)
endef

define KernelPackage/usb-net-iburst/description
 Kernel module for iBurst USB High Speed Mobile Devices
endef

$(eval $(call KernelPackage,usb-net-iburst))
...
define KernelPackage/usb-net-rndis/description
 Kernel support for USB RNDIS connections
endef
...
define KernelPackage/usb-beceem-wimax
  $(call usbdep, @LINUX_2_6)
  TITLE:=USB Beceem WiMAX Driver
  KCONFIG:=CONFIG_USB_BECEEM_WIMAX=m
  FILES:=$(LINUX_DIR)/drivers/usb/drxvi314/drxvi314.ko
  AUTOLOAD:=$(call AutoLoad,70,drxvi314)
endef

define KernelPackage/usb-beceem-wimax/description
 Kernel support for Beceem WiMAX Driver
endef

$(eval $(call KernelPackage,usb-beceem-wimax))
