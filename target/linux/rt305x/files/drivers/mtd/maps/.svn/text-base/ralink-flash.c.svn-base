...
static struct mtd_partition rt2880_partitions[] = {
        {
                name:           "Bootloader",  /* mtdblock0 */
                size:           MTD_BOOT_PART_SIZE,  /* defined in ralink-flash.h */
                offset:         0,
        }, {
                name:           "Config", /* mtdblock1 */
                size:           MTD_CONFIG_PART_SIZE,  /* defined in ralink-flash.h*/
                offset:         MTDPART_OFS_APPEND,
        }, {
                name:           "Factory", /* mtdblock2 */
                size:           MTD_FACTORY_PART_SIZE,  /* defined in ralink-flash.h*/
                offset:         MTDPART_OFS_APPEND,
        }
#ifdef CONFIG_RT2880_ROOTFS_IN_FLASH
#ifdef CONFIG_RT3052_FLASH_4M
        , {
...
#ifndef EZPACKET
        , {
                name:           "nvram", /* mtdblock6 */
                size:           0x10000,
                offset:         0x3E0000,
        }, {
                name:           "nvram_backup", /* mtdblock7 */
                size:           0x10000,
                offset:         0x3F0000,
        }
#endif
...
int __init rt2880_mtd_init(void)
{
	...
	for (i = 0; i < NUM_FLASH_BANKS; i++) {
		...
		if (ralink_mtd[i]) {
			...
			/* EZP: ralink_mtd[i]->lock = ralink_lock;
